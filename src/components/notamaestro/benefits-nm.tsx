...
export function BenefitsNM() {
  return (
    <section className="relative isolate overflow-hidden bg-gradient-to-b from-[#fff7eb]/50 to-white py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {notamaestro.benefits.items.map((b) => {
            ...
            return (
              <motion.div
                ...
                className={cn(
                  "group relative overflow-hidden rounded-3xl p-7 transition-all",
                  b.featured
                    ? "bg-gradient-to-br from-notamaestro to-notamaestro-dark text-white shadow-2xl shadow-notamaestro/40 lg:scale-[1.02]"
                    : "border border-neutral-200 bg-white text-codfy-ink hover:border-notamaestro/30 hover:shadow-md"
                )}
              >
                <div
                  className={cn(
                    ...
                    b.featured
                      ...
                      : "bg-notamaestro/10 text-notamaestro-dark ring-1 ring-notamaestro/20"
                  )}
                >
                  {Icon && <Icon className="h-7 w-7" />}
                </div>
                <h3 className="font-display text-xl font-bold">{b.title}</h3>
                <p className={cn("mt-3 text-sm leading-relaxed", b.featured ? "text-white/85" : "text-neutral-600")}>
                  {b.description}
                </p>
                  ...
                  {b.bullets.map((bullet) => (
                    <li
                      ...
                      className={cn(
                        ...
                        b.featured ? "text-white/90" : "text-neutral-700"
                      )}
                    >
                      <Check
                        className={cn(
                          "mt-0.5 h-4 w-4 shrink-0",
                          b.featured ? "text-white" : "text-notamaestro"
                        )}
                      />
                      <span>{bullet}</span>
                    </li>
        ...
        <Reveal delay={0.2} className="mx-auto mt-20 max-w-4xl">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-notamaestro via-notamaestro-dark to-[#8a4a08] p-10 text-center text-white shadow-2xl shadow-notamaestro/30">
            ...
            <div className="relative">
              ...
              <div className="mt-8 grid grid-cols-3 gap-4 border-t border-white/20 pt-6 max-w-md mx-auto">
