...
export function Navbar() {
  ...
  return (
    <motion.header
      ...
      className={cn(
        "fixed inset-x-0 top-0 z-40 border-b transition-[background-color,backdrop-filter,border-color,box-shadow] duration-300",
        scrolled
          ? "border-white/10 bg-codfy-ink/75 backdrop-blur-xl shadow-[0_4px_24px_-12px_rgba(0,0,0,0.6)]"
    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 md:h-20 lg:px-8">
        ...
        <div className="hidden lg:flex">
          <ButtonLink href="/#contacto" size="default" variant="primary">
            Empezar ahora
          </ButtonLink>
        </div>
