...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-emerald-500/30 transition-all hover:scale-110 hover:shadow-emerald-500/50 md:bottom-8 md:right-8 md:h-16 md:w-16"
